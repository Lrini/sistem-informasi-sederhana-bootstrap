      ...
      <div class="box">
        <div class="box-header with-border">
         ...
         <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Tabel Fasilitas </h3>
			 </div>
			 <!-- /.box-header -->
                                ...
                                <?php 
                                  ...
                                  while ($row=mysql_fetch_array($sql)) {
                                    ?>
                                      ...
                                      <td><?php echo $row['id_fas'] ?></td>
                                      <td><?php echo $row['nama_fas'] ?></td>
                                 ...
                                 <td>
                                  <div class="btn-group">
                                      <a class="btn btn-primary fa fa-edit" href="edit_fas.php?id_fas=<?php echo $row['id_fas'] ?>"><i class="icon_plus_alt2"></i></a>
                                     
                                      <a class="btn btn-danger fa fa-close" onclick="return konfirmasi()" href="hapus_fas.php?id_fas=<?php echo $row['id_fas'] ?>"><i class="icon_close_alt2"></i></a>
                                  </div>
                                  </td>
                              </tr>
                                    <?php
