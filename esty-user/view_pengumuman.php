<?php 
					...
					$data = mysqli_query($conn,"SELECT * FROM pengumuman where id_pengumuman='$id_pengumuman'");
?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="container">		
		...
		?>
			<div class="col-sm-12 text-center w3ls">
				...
				<p class="p1 animated wow fadeInUp animated animated" data-wow-duration="1200ms" data-wow-delay="500ms"></p><p><?php echo $data['pengumuman'];?> </p>
