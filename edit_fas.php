...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="box-header with-border">
         ...
         <div class="box box-primary">
			...
			<?php 
					include 'koneksi.php';
					$id_fas=$_GET['id_fas'];
					$data = mysql_query("SELECT * FROM fasilitas where id_fas='$id_fas'");
					$edit = mysql_fetch_array($data);
			?>
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">No Fasilitas</label>
                  <input type="text" class="form-control" name="id_fas" value="<?php echo $edit['id_fas'] ?>"  disabled='disabled' />
				  <input type="hidden" name="id_fas" value="<?php echo $edit['id_fas'] ?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Nama fasilitas</label>
                  <input type="text" class="form-control" name="nama_fas" value="<?php echo $edit['nama_fas'] ?>"/>
                </div>
				 <div class="form-group">
                  <label for="exampleInputPassword1">Deskripsi</label>
					<textarea name="deskripsi" id="news"><?php echo $edit['deskripsi'] ?></textarea>
    ...
    if($movie){
        ...
        $nama_fas =$_POST['nama_fas'];
		$deskripsi = $_POST['deskripsi'];
		$id_unit = $_POST ['id_unit'];
        $sql = mysql_query("UPDATE fasilitas set foto='$fileName', nama_fas='$nama_fas',deskripsi='$deskripsi',id_unit='$id_unit' where id_fas='$id_fas'");

        if($sql){
          ?>
          <script type="text/javascript">
            alert('Berhasil');window.location='tabel_fasilitas.php';
          </script>
        <?php
				}
	}else {
		...
		$deskripsi = $_POST['deskripsi'];
		$id_unit = $_POST ['id_unit'];
        $sql = mysql_query("UPDATE fasilitas set nama_fas='$nama_fas',deskripsi='$deskripsi',id_unit='$id_unit' where id_fas='$id_fas'");
		 if($sql){
          ?>
          <script type="text/javascript">
            alert('Berhasil');window.location='tabel_fasilitas.php';
