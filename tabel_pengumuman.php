				...
				<tr>
						  <tr>
                                <?php 
                                 ...
                                 <td>
                                  <div class="btn-group">
                                      <a class="btn btn-primary fa fa-edit" href="edit_pengumuman.php?id_pengumuman=<?php echo $row['id_pengumuman'] ?>"><i class="icon_plus_alt2"></i></a>
                                     
                                      <a class="btn btn-danger fa fa-close" onclick="return konfirmasi()" href="hapus_pengumuman.php?id_pengumuman=<?php echo $row['id_pengumuman'] ?>"><i class="icon_close_alt2"></i></a>
                                  </div>
                                  </td>
                              </tr>
                                    <?php
