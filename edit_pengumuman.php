...
if(isset($_POST['edit'])){
    ...
    $sql = mysql_query("UPDATE pengumuman set judul='$judul',pengumuman='$pengumuman',id_admin='$id_admin' where id_pengumuman ='$id_pengumuman'");
        ...
        <div class="box-header with-border">
         ...
         <div class="box box-primary">
			...
			<?php 
					...
					$data = mysql_query("SELECT * FROM pengumuman where id_pengumuman='$id_pengumuman'");
					$edit = mysql_fetch_array($data);
			?>
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">No pengumuman</label>
                  <input type="text" class="form-control" name="id_pengumuman" value="<?php echo $edit['id_pengumuman'] ?>"  disabled='disabled' />
				  <input type="hidden" name="id_pengumuman" value="<?php echo $edit['id_pengumuman'] ?>">
                </div>
                <div class="form-group">
				 ...
				 <div class="form-group">
                  <label for="exampleInputPassword1">Deskripsi</label>
					<textarea name="pengumuman" id="news"><?php echo $edit['pengumuman'] ?></textarea>
						<script type="text/javascript">
				 ...
				 <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="id_admin" value="<?php echo $edit['id_admin'] ?>" disabled='disabled' />
