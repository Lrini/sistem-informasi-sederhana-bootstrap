...
<!-- Banner -->
	...
	<div class="container">
		<h1>fasilitas</h1> 
			...
			$query = $conn->query("select * from fasilitas LIMIT $mulai, $halaman")or die(mysqli_error);
			$no =$mulai+1;
			 
			while ($data = $query->fetch_object()) { ?>
			
				<div class="view view-seventh">
                    <a class="b-link-stripe b-animate-go" title="Image Title"><img src="../foto/<?php echo $data->foto; ?>" alt="" class="img-responsive">
                    <div class="mask">
                       <h2><?php echo $data->nama_fas;?></h2>
                        <p><?php echo "".substr(strip_tags($data->deskripsi),0,100)."..."?></p>
						<p><?php echo "".substr(strip_tags($data->id_unit),0,100)."..."?></p>
