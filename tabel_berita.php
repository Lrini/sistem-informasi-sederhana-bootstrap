                                ...
                                <?php 
                                  ...
                                  while ($row=mysql_fetch_array($sql)) {
                                    ?>
									  ...
									  <td>
                                        <img src="foto/<?php echo $row['foto_ber']; ?>" width="100">
                                      </td>
                                      <td><?php echo $row['deskrip_berit'] ?></td>
                                 ...
                                 <td>
                                  <div class="btn-group">
                                      <a class="btn btn-primary fa fa-edit" href="edit_berita.php?id_berita=<?php echo $row['id_berita'] ?>"><i class="icon_plus_alt2"></i></a>
                                     
                                      <a class="btn btn-danger fa fa-close" onclick="return konfirmasi()" href="hapus_berita.php?id_berita=<?php echo $row['id_berita'] ?>"><i class="icon_close_alt2"></i></a>
                                  </div>
                                  </td>
                              </tr>
                                    <?php
