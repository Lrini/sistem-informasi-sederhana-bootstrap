...
if(isset($_POST['edit'])){
    ...
    $sql = mysql_query("UPDATE unit set nama_unit='$nama_unit',deskripsi_unit='$deskripsi_unit' where id_unit='$id_unit'");
      ...
      <div class="box">
        <div class="box-header with-border">
         ...
         <div class="box box-primary">
			...
			<?php 
					...
					$data = mysql_query("SELECT * FROM unit where id_unit='$id_unit'");
					$edit = mysql_fetch_array($data);
			?>
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">No Unit</label>
                  <input type="text" class="form-control" name="id_unit" value="<?php echo $edit['id_unit'] ?>"  disabled='disabled' />
				  <input type="hidden" name="id_unit" value="<?php echo $edit['id_unit'] ?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Nama Unit</label>
                  <input type="text" class="form-control" name="nama_unit" value="<?php echo $edit['nama_unit'] ?>"/>
                </div>
				 <div class="form-group">
                  <label for="exampleInputPassword1">Deskripsi</label>
					<textarea name="deskripsi_unit" id="news"><?php echo $edit['deskripsi_unit'] ?></textarea>
						<script type="text/javascript">
        ...
        <!-- /.box-body -->
		 <div class="box-footer">
                <input type="submit" name="edit" value="EDIT" class="btn btn-success fa fa-check">
              </div>
            </form>
          </div>
        <div class="box-footer">
