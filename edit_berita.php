...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="box-header with-border">
         ...
         <div class="box box-primary">
			...
			<?php 
					...
					$data = mysql_query("SELECT * FROM berita where id_berita='$id_berita'");
					$edit = mysql_fetch_array($data);
			?>
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">No Fasilitas</label>
                  <input type="text" class="form-control" name="id_berita" value="<?php echo $edit['id_berita'] ?>" />
				  <input type="hidden" name="id_berita" value="<?php echo $edit['id_berita'] ?>">
                </div>
				 <div class="form-group">
                  <label for="exampleInputPassword1">Deskripsi</label>
					<textarea name="deskrip_berit" id="news"><?php echo $edit['deskrip_berit'] ?></textarea>
				...
				<div class="form-group">
				 ...
				 <div class="form-group">
                  <label for="exampleInputPassword1">id_admin</label>
                  <input type="text" class="form-control" name="id_admin" value="<?php echo $edit['id_admin'] ?>"  />
				  <input type="hidden" name="id_admin" value="<?php echo $edit['id_admin'] ?>">
                </div>
        <!-- /.box-body -->
		 <div class="box-footer">
                <input type="submit" name="edit" value="EDIT" class="btn btn-success fa fa-edit">
              </div>
            </form>
			<?php 
     include 'koneksi.php';
    ...
    if($movie){
		...
		$deskrip_berit = $_POST['deskrip_berit'];
		$id_unit = $_POST ['id_unit'];
		$id_admin = $_POST['id_admin'];
        $sql = mysql_query("UPDATE berita set foto_ber='$fileName',deskrip_berit='$deskrip_berit',id_unit='$id_unit',id_admin='$id_admin' where id_berita='$id_berita'");

				if($sql){
							?>
								<script type="text/javascript">
								alert('Berhasil');window.location='tabel_berita.php';
								</script>
							<?php
						}
							} else {
							...
							$id_unit = $_POST ['id_unit'];
							$id_admin = $_POST['id_admin'];
							$sql = mysql_query("UPDATE berita set deskrip_berit='$deskrip_berit',id_unit='$id_unit',id_admin='$id_admin' where id_berita='$id_berita'");	
							if($sql){
							?>
								<script type="text/javascript">
								alert('Berhasil');window.location='tabel_berita.php';
