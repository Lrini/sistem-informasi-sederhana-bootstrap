...
<!-- Banner -->
	...
	<!-- //Header -->
		...
		<div class="container">
			...
			<div class="contact-form">
				<div class="col-md-4 contact-form-left agile-3">
					...
					<p>Jln. Penfui</p>
					<p>Telephone : </p>
					<a href="angkasapura@gmail.com">angkasapura@gmail.com</a>
				</div>
				<div class="col-md-8 contact-form-right  agileits-3">
					...
					<table>
						<tr>
							...
							<td>
								<button type="submit" class="btn btn-primary" name="simpan" value="SIMPAN" >KIRIM</button>
							</td>
						</tr>
					</table>
					</form>
		...
		$nama =$_POST['nama'];
        $sql = mysql_query("INSERT INTO kontak (nama)values('$nama')");
       if($sql){
          ?>
          <script type="text/javascript">
            alert('Berhasil');window.location='kontak.php';
          </script>
          <?php
        }
	 }
