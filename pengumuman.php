  ...
  <div class="content-wrapper">
      ...
      <div class="box">
        <div class="box-header with-border">
         ...
         <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Input Pengumuman</h3>
			 </div>
			 <!-- /.box-header -->
            <!-- form start -->
    ...
    include 'koneksi.php';
	 if(isset($_POST['simpan'])){
		...
		echo "id = " . $id_adm;
		$judul = $_POST ['judul'];
        $sql = mysql_query("INSERT INTO pengumuman (id_pengumuman,id_admin,judul,pengumuman)values ('$id_pengumuman','$id_adm','$judul','$pengumuman')");

       if($sql){
          ?>
          <script type="text/javascript">
            alert('Berhasil');window.location='tabel_pengumuman.php';
          </script>
          <?php
        }
	 }
