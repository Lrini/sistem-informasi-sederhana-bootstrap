...
<!-- Banner -->
	...
	<div class="container">
		<h1>Berita</h1> 
			...
			$query = $conn->query("select * from berita LIMIT $mulai, $halaman")or die(mysqli_error);
			$no =$mulai+1;
			 
			while ($data = $query->fetch_object()) { ?>
			
				<div class="view view-seventh">
                    <a href="view_berita.php?id_berita=<?php echo $data->id_berita;?>" class="b-link-stripe b-animate-go" title="Image Title"><img src="../foto/<?php echo $data->foto_ber; ?>" alt="" class="img-responsive">
                    <div class="mask">
