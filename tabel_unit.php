                                ...
                                <?php 
                                  ...
                                  while ($row=mysql_fetch_array($sql)) {
                                    ?>
                                      ...
                                      <td><?php echo $row['deskripsi_unit'] ?></td>
                                 
                                 <td>
                                  <div class="btn-group">
                                      <a class="btn btn-primary fa fa-edit" href="edit_unit.php?id_unit=<?php echo $row['id_unit'] ?>"><i class="icon_plus_alt2"></i></a>
                                     
                                      <a class="btn btn-danger fa fa-close" onclick="return konfirmasi()" href="hapus_unit.php?id_unit=<?php echo $row['id_unit'] ?>"><i class="icon_close_alt2"></i></a>
                                  </div>
                                  </td>
                              </tr>
                                    <?php
