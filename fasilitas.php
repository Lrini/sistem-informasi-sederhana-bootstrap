  ...
  <div class="content-wrapper">
                ...
                <div class="form-group">
				 ...
				 <div class="form-group">
                  <label for="exampleInputPassword1">Deskripsi</label>
					<textarea name="deskripsi_unit" id="news"></textarea>
						<script type="text/javascript">
								var editor = CKEDITOR.replace('news');  
													...
													<div class="radio">
													<label>
														<input name="jk" id="jk1" value="wajib" type="radio" class="ace" />
												...
												<div class="radio">
													<label>
														<input name="jk" id="jk2" value="belum" type="radio" class="ace" />
    ...
    include 'koneksi.php';
	 if(isset($_POST['simpan'])){
		...
		$id_fas = $_POST['id_fas'];
		$jenis = $_POST['jk'];
        $sql = mysql_query("INSERT INTO unit (nama_unit,deskripsi_unit,jenis)values ('$nama_unit','$deskripsi_unit','$jenis')");

       if($sql){
          ?>
          <script type="text/javascript">   
            alert('Berhasil');window.location='tabel_unit.php';
          </script>
          <?php
        }
	 }
